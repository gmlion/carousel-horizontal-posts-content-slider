...
class CHPCS {
	...
	foreach( $myposts as $post ){
		...
		$slider_gallery .= '<div class="custom_container">';
		...
		if($display_title){
		$slider_gallery.= '<span class="chpcs_title"><a  style=" text-decoration:none;" href="'.$post_link.'">'.$post_title.'</a></span>';
		}
		...
		$slider_gallery.= '<span class="chpcs_more"><a href="'.$post_link.'">'.$read_more_text.'</a></span>';
		}
		
		$slider_gallery.= '</div>'; /*custom_container*/
